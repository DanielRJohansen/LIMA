...
namespace NListUtils {
	...
	void NListUtils::matchCompoundNeighbors(Simulation* simulation, NListDataCollection* nlist_data_collection) {
...
void NListUtils::updateCompoundGrid(Simulation* simulation, NListDataCollection* nlist) {
	*nlist->compoundgrid = CompoundGrid{};	// Reset the grid
	...
	NListUtils::distributeCompoundsInGrid(simulation, *nlist);
