...
struct EngineBatchData {
	...
	CudaBuffer<SimulationDeviceData> simulationsDevice;
	SimParams params;
	Int3 boxSize;
	int64_t step = 0;
	int nPclusters = 0;
	...
	int nActiveSuperclusters = 0;
	int nActivePclusters = 0;
	int nActiveBondgroups = 0;
	int nResults = 0;
	float ewaldKappa = 0.f;
	CudaBuffer<int> pclusterSimulationIds;
	CudaBuffer<int> activePclusterIds;
	CudaBuffer<int> activeBondgroupIds;
	CudaBuffer<int> activeSuperclusterIds;
